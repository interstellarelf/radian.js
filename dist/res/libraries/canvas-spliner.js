(function(global, factory) {
  ...
  CubicSpline = function() {
    ...
    CubicSpline.prototype.derivative = function() {
      ...
      for (x = 0, _ref3 = this.d.length;
        (0 <= _ref3 ? x < _ref3 : x > _ref3);
        (0 <= _ref3 ? x += 1 : x -= 1)) {
        s.d = 0;
      }
  ...
  class CanvasSpliner {
    ...
    constructor(parentContainer, width, height, splineType = 'natural') {
      ...
      this._borderStyle = { in: "1px solid #d3d3ff",
